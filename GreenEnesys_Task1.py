...
print(f'From 1000 random rent amounts from the following distribution, {x/10}% the assets IRR was bigger than 4%.\nwhich means that given that the asset does not match the customers conditions of 5% risk tolerance\n\nthe log of the time the procces took is {log_time}')
